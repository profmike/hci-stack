...
```bash
_V=$(cat ~/.claude/skills/hci-office-hours/VERSION 2>/dev/null || echo "unknown")
echo "hci-office-hours v$_V"
```
...
if [ -d ~/.claude/skills/hci-office-hours/.git ]; then
  ...
  curl -sf "https://raw.githubusercontent.com/profmike/hci-stack/main/hci-office-hours/SKILL.md" \
    -o ~/.claude/skills/hci-office-hours/SKILL.md
...
Generated by /hci-office-hours v{version} on {date}
Status: DRAFT
